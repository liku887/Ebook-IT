...
function createDOMPurify() {
  ...
  const _createNodeIterator = function _createNodeIterator2(root3) {
    const doc = getOwnerDocument ? getOwnerDocument(root3) : root3.ownerDocument;
  ...
  const _sanitizeDisallowedNode = function _sanitizeDisallowedNode2(currentNode, tagName, root3) {
    ...
    if (KEEP_CONTENT && !FORBID_CONTENTS[tagName]) {
      ...
      if (childNodes && parentNode) {
        ...
        for (let i = childCount - 1; i >= 0; --i) {
          const hoisted = currentNode === root3 ? cloneNode(childNodes[i], true) : childNodes[i];
  ...
  const _forkSharedAllowlist = function _forkSharedAllowlist2(hookList, set4, defaultSet, setConfigSet) {
    if (hookList.length === 0) {
      return set4;
    }
    return set4 === defaultSet || set4 === setConfigSet ? clone(set4) : set4;
  };
  const _sanitizeElements = function _sanitizeElements2(currentNode, root3) {
    ...
    if (FORBID_TAGS[tagName] || !(EXTRA_ELEMENT_HANDLING.tagCheck instanceof Function && EXTRA_ELEMENT_HANDLING.tagCheck(tagName)) && !ALLOWED_TAGS[tagName]) {
      const removed = _sanitizeDisallowedNode(currentNode, tagName, root3);
      if (removed === false) {
...
var loader$m = async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-3f4bdde3-TBYXM3LZ.js");
...
var loader$l = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-1629c991-Y2VHXDYP.js");
...
var loader$k = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-v2-1d953310-TBN77CNF.js");
...
var loader$j = async () => {
  const { diagram: diagram2 } = await import("./erDiagram-5d81789a-F5RTDG4A.js");
...
var loader$i = async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-f01e8bc2-KTOUAU7N.js");
...
var loader$h = async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-3b0b3873-WYOPGOIB.js");
...
var loader$g = async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-a29d40f1-7FY7TEC7.js");
...
var loader$f = async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-c941bede-55MENZC5.js");
...
var loader$e = async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-cf8b8fe0-RZQ6JTYC.js");
...
var loader$d = async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-3f383b91-4ITN6L4O.js");
...
var loader$c = async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-53bda41b-PFS4SKP6.js");
...
var loader$b = async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-82a5b84f-M7BISZ7Q.js");
...
var loader$a = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-f62afe4f-X4Q7FENW.js");
...
var loader$9 = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-604399ef-S77NDRFS.js");
...
var loader$8 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-43e79a5f-66VEAX2W.js");
...
var loader$7 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-2041ed4f-DAT2D6TM.js");
...
var loader$6 = async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-95396277-46NNDLVF.js");
...
var loader$5 = async () => {
  const { diagram: diagram2 } = await import("./flowchart-elk-definition-6df44142-QPDYQHIV.js");
...
var loader$4 = async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-7545f45a-HABY5A3L.js");
...
var loader$3 = async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-e4c1d938-T5VTUSRO.js");
...
var loader$2 = async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-c3ef121a-HN3X24LP.js");
...
var loader$1 = async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-868be97b-LMOGD4HT.js");
...
mermaid/dist/mermaid-934da031.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-TYO6YKS7.js.map
